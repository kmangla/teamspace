...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  // Update Employee 
  'post /employee/:id' : 'UserController.updateEmployee',
  // Delete Employee
  'delete /employee/:id' : 'UserController.deleteEmployee',
  // Create a Task
  'post /task': 'TaskController.create',
  // List task for an employee
  'get /task': 'TaskController.list',
  //List all tasks assigned by user
  'get /tasks': 'TaskController.listAll',
  // Update a Task
  'post /task/:id': 'TaskController.updateTask',
  // Delete a Task
  ...
  'post /token': 'PushTokenController.register',
  // OTP generate
  'post /generateOTP': 'OTPController.generate',
  // OTP verify
  'get /verifyOTP': 'OTPController.verify',
  // Logging
  'post /metrics': 'LogController.logData',
  // Error Logging
